...
namespace UnityEngine.PostProcessing.Utilities
{
    ...
    public class PostProcessingControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (_controlAntialiasing.boolValue)
            {
            ...
            if (_controlAmbientOcclusion.boolValue)
            {
            ...
            if (_controlScreenSpaceReflection.boolValue)
            {
            ...
            if (_controlDepthOfField.boolValue)
            {
            ...
            if (_controlMotionBlur.boolValue)
            {
            ...
            if (_controlEyeAdaptation.boolValue)
            {
            ...
            if (_controlColorGrading.boolValue)
            {
            ...
            if (_controlChromaticAberration.boolValue)
            {
