...
public class InteractableEditor : EditorWithSubEditors<ConditionCollectionEditor, ConditionCollection>
{
	...
	private SerializedProperty defaultElecReactionCollectionProperty;  
	private SerializedProperty defaultIceReactionCollectionProperty;  
	private SerializedProperty defaultWaterReactionCollectionProperty;  
	private SerializedProperty defaultWindReactionCollectionProperty; 
	...
	private const string interactablePropDefaultElecReactionCollectionName = "defaultElecReactionCollection";
	private const string interactablePropDefaultIceReactionCollectionName = "defaultIceReactionCollection";
	private const string interactablePropDefaultWaterReactionCollectionName = "defaultWaterReactionCollection";
	private const string interactablePropDefaultWindReactionCollectionName = "defaultWindReactionCollection";
    ...
    private void OnEnable ()
    {
		...
		defaultElecReactionCollectionProperty = serializedObject.FindProperty(interactablePropDefaultElecReactionCollectionName);
		defaultIceReactionCollectionProperty = serializedObject.FindProperty(interactablePropDefaultIceReactionCollectionName);
		defaultWaterReactionCollectionProperty = serializedObject.FindProperty(interactablePropDefaultWaterReactionCollectionName);
		defaultWindReactionCollectionProperty = serializedObject.FindProperty(interactablePropDefaultWindReactionCollectionName);
    ...
    public override void OnInspectorGUI ()
    {
		...
		EditorGUILayout.PropertyField (defaultElecReactionCollectionProperty);
		EditorGUILayout.PropertyField (defaultIceReactionCollectionProperty);
		EditorGUILayout.PropertyField (defaultWaterReactionCollectionProperty);
		EditorGUILayout.PropertyField (defaultWindReactionCollectionProperty);
