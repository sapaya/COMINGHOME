...
public class ConditionCollectionEditor : EditorWithSubEditors<ConditionEditor, Condition>
{
    ...
    private SerializedProperty reactionSetProperty;      // Represents the ReactionCollection that is referenced by the target.
	private SerializedProperty forceTypeProperty;
    ...
    private const string conditionCollectionPropReactionSetName = "reactionSet";
                                                                // Name of the field that represents the ReactionCollection that is referenced by the target.
	private const string conditionCollectionPropForceTypePropertyName = "assignedForce";
    ...
    private void OnEnable ()
    {
        ...
        reactionSetProperty = serializedObject.FindProperty(conditionCollectionPropReactionSetName);
		forceTypeProperty = serializedObject.FindProperty(conditionCollectionPropForceTypePropertyName);
    ...
    private void ExpandedGUI ()
    {
		...
		EditorGUILayout.PropertyField(forceTypeProperty);
        ...
        EditorGUILayout.PropertyField(reactionSetProperty);
    }
